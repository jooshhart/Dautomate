...
class DataPage(ScrollableFrame):
    def __init__(self, parent, controller):
        ...
        for entry in (eff_xlabel_entry, eff_ylabel_entry, eff_title_entry):
        ...
        for entry in (loss_xlabel_entry, loss_ylabel_entry, loss_title_entry):
        ...
        for entry in (comb_xlabel_entry, comb_eff_ylabel_entry, comb_loss_ylabel_entry, comb_title_entry):
    ...
    def show_dataframe(self, df, col_map=None):
        ...
        self.show_eff_plot(df)
        self.show_loss_plot(df)
        self.show_combined_plot(df)
